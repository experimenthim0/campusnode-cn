        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="sm:col-span-2">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:ring-2 focus:ring-brand-500 outline-none"
            />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
              <div>
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center gap-2.5 border-2 border-dashed border-neutral-300 dark:border-neutral-700 rounded-xl p-5 text-center cursor-pointer hover:border-brand-500 hover:bg-brand-50/40 dark:hover:bg-brand-950/20 transition-all ${
                ...
                >
                  {uploadingPoster ? (
                    ...
                    <>
                      <div className="w-10 h-10 rounded-full bg-brand-100 dark:bg-brand-950/50 flex items-center justify-center text-brand-600">
                        <Upload size={18} />
                      </div>
                      <div>
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2.5 text-xs rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:ring-2 focus:ring-brand-500 outline-none"
                  />
                </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:ring-2 focus:ring-brand-500 outline-none cursor-pointer"
            >
